...
import com.example.swnuclearfusionwas.domain.oauthjwt.service.AuthInitialSetupService;
...
public class AuthInitialSetupController {
    ...
    @Operation(
            ...
            description = """
        소셜 로그인 직후 한 번의 호출로 역할(SENIOR|GUARDIAN)과 전화번호(숫자 11자리)를 동시에 설정합니다.
    ...
    public ResponseEntity<?> initialSetup(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    ...
                    content = @Content(mediaType = "application/json",
                            ...
                            examples = {
                                    @ExampleObject(name = "SENIOR", value = "{ \"role\":\"SENIOR\", \"phone\":\"01012345678\" }"),
                                    @ExampleObject(name = "GUARDIAN", value = "{ \"role\":\"GUARDIAN\", \"phone\":\"01099998888\" }")
                            })
            )
